<template>
  ...
  >
    ...
    <a-form-item label="兼职/任职单位名称" v-show="isWorkOther()">
      <a-input v-decorator="field.avoSite.dec" v-bind="field.avoSite.other" />
    </a-form-item>
    <a-form-item label="兼职/任职职务" v-show="isWorkOther()">
...
import {
  ...
  textarea,
  formItemLayout,
} from "@/views/main/my-attestation/common/style";
import {
  areaOption,
  expOption,
  lawAdvList,
...
import Deploy, {
  getFileList,
  getValueFromEvent,
} from "@/plugin/tools/qiniu-deploy";
