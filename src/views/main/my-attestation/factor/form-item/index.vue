<template>
  <div>
    <FormLaw ref="LawFormRef" :source="lawData" :isFirst="true" v-if="role===1"/>
    <FormOrg ref="OrgFormRef" :source="orgData" :isFirst="false" v-if="role===2"/>
    <FormPublic ref="PublicFormRef" :source="publicData" :role="role===1?'lawyer':'org'" :isFirst="true"/>
    <FormOffice v-if="role===1&&officeInfo" ref="OfficeFormRef" :source="officeData" :isFirst="true"/>
